...
function center() {
  ...
  switch (pageDependancy) {
    case ("database"):
      star_of_the_show = [db, "--db_width", 0.7, 1.0]
      break;
    case ("petition"):
...
function initialize(page) { // we're calling this function the moment the html body loads.
  ...
  pageDependancy = page;
  newEntry([`lemon`                 , [`Lemon`, `(He/Him)`]     , `lemon.jpg`     , [[`@LEMONSYSEXE`  , `https://x.com/LEMONSYSEXE`   ], [`Strawpage`, `https://lemondotexe.straw.page`]], `PauIndeed`,`🟡: Hiiii im lemon and i like being friends with anybody!! I try to be as friendly as possible :D`,`🟡> example`, `Active`]);
  newEntry([`lime`                  , [`Lime`, `(He/Him)`]      , `lime.jpg`      , [[`@LEMONSYSEXE`  , `https://x.com/LEMONSYSEXE`   ], [`Strawpage`, `https://lemondotexe.straw.page`]], `PauIndeed`  ,`🟢: My name is Lime.. I might be a bit cold, though I'm tryna change my ways.. uh... yeah...!!`,`🟢> example`, `Active`]);
  newEntry([`neroli`                , [`Neroli`, `(He/They/It)`]    , `neroli.jpg`    , [[`@LEMONSYSEXE`  , `https://x.com/LEMONSYSEXE`   ], [`Strawpage`, `https://lemondotexe.straw.page`]], `PauIndeed`  ,`🐟: Neroli here... uhm.. just some dude roaming around. Not much more... Uh.... i like fish`,`🐟> example`, `Active`]);
  newEntry([`stardust`              , [`Stardust`, `(He/Him)`]  , `stardust.jpg`  , [[`@LEMONSYSEXE`  , `https://x.com/LEMONSYSEXE`   ], [`Strawpage`, `https://lemondotexe.straw.page`]], `PauIndeed`  ,`⭐: Stardust. Creator, and parent of Lemon, Lime, Flora... I used to be a human back in the day.`,`⭐️> example`, `Active`]);
  newEntry([`lovedeath`             , [`Lovedeath`, `(He/Him/They)`] , `lovedeath.jpg` , [[`@LEMONSYSEXE`  , `https://x.com/LEMONSYSEXE`   ], [`Strawpage`, `https://lemondotexe.straw.page`]], `PauIndeed`  ,`💜: Heyyy!! I'm Lovedeath X] The COOLER of them all!!! Yeah!!! >:]`,`💜> example`, `Active`]);
  newEntry([`flora`                 , [`Flora`, `(She/Her)`]     , `flora.jpg`     , [[`@LEMONSYSEXE`  , `https://x.com/LEMONSYSEXE`   ], [`Strawpage`, `https://lemondotexe.straw.page`]], `PauIndeed`  ,`🌻: I am Flora... I'm always glad to meet anybody inside of this platform! But don't be a bloody dick to me, will you.`,`🌻> example`, `Active`]);
  newEntry([`hydrangea`             , [`Hydrangea`, 'She/Her'],`hydrangea.jpg`,[[`@solstice_labs`,`https://x.com/solstice_labs`],[`Strawpage`,`https://solsticelabs.straw.page`]],`PauIndeed`,`Abandoned machinery inside of Solstice Laboratories. I used to be something in the past.`,``,`Active`]);
  ...
  newEntry([`coder`                 , [`Coder`,`He/him`],`coder.jpg`,[[`@the_coder244`,`https://x.com/the_coder244`],[`Coders very awesome strawpage `,`https://coder.straw.page`]],`(anonymous)`,`(Hello! Im coder, I am a code bot made in the year of 1988 for the company CGA),(my goal is to nowadays just be nice and code when I have to!)`,`one concept was talking like 🌚-, now (this )`,`Active`]);
  ...
  newEntry([`drone_#4`              , [`Drone #4`,`Any/all`],`drone_4.jpg`,[[`@computerlings`,`https://x.com/computerlings`]],`Joanne Drone`,`Former community mananger of C:/omputerlings!`,`I'm  [Out/In] .... no, I => BACK !!! w/ That New Flavor,  returns to:  theFuck'n  COMMUNITY (AGAIN)!!!  *Feel*  my: {Power, + Rage}.  @ the Function...-- hey^3, this sentence == >> gibberish << !!!!! - Drone #5`,`Retired`]);
  newEntry([`each`                  , [`Evren "EACH"`,`he/they`],`each.jpg`,[[`@EACHBotEXE`,`https://x.com/EACHBotEXE`],[`Account Admin Main`,`https://x.com/StupidScribblez`],[`Account Admin Discord`,`@dunnevoice`]],`Darragh / StupidScribblez "Scrib"`,`EACH is a medical aid-turned chatbot/shoulder to cry on; EACH is a friendly computerling but isn't afraid to stand his ground to defend himself or those he cares about. His main goal is to keep Admins health in check, and to keep the other computerlings getting along (he's currently training younger brother PAL to help with the latter.)`,`EACH has no "typing quirk", but to distinguish between characters/IC and OOC, EACH's non-text posts use a " > 💚" preceeding the text, for example, "> 💚: "Hello! I'm EACH, how can I help?"`,`Active`]);
  newEntry(['vector'                , ['Vector','He/Him'],'vector.jpg',[['@Vectorv3DS','https://x.com/Vectorv3DS'],['v3DS','https://v3ds.straw.page/']],'(anonymous)','Vector is a Work-In-Progress project and the main attraction behind the company ’v3DS’. v3DS isn’t very well known, but they seem hellbent on perfecting Vector for some reason.','>: This is my Example Text.','Hiatus']);
  newEntry([`neneitsi_echmuan`,[`Neneitsi Echmuan`,`She/Any`],`neneitsi_echmuan.jpg`,[[`@NeneitsiEchmuan`,`https://x.com/NeneitsiEchmuan`]],`GarnetSoEpic`,`Hey, uhh... I'm in a lab, I guess? I don't know.`,``,`Hiatus`])
  newEntry([`flesheater`,[`FLESHEATER`,`He/It`],`flesheater.jpg`,[[`@num1fleshfan`,`https://x.com/num1fleshfan`]],`GarnetSoEpic`,`G|I|V|E|M|E|F|L|E|S|H|.|G|I|V|E|M|E|M|E|A|T|.I|A|M|A|L|W|A|Y|S|H|U|N|G|R|Y|.`,`S|A|M|P|L|E|T|E|X|T|.`,`Active`])
  newEntry([`ivan`,[`Ivan`,`He/Him`],`ivan.jpg`,[[`@SukantoRobotics`,`https://x.com/SukantoRobotics`],[`StrawPage`,`https://scph70012.straw.page/`]],`Chip Macro`,`A human who had his soul put in a robot body. He's currently best friends with Nick, the person who created the 3 main AIs on the Sukanto Robotics account.`,`(💠) Sample text.`,`Active`])
